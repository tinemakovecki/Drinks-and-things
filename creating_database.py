...
def search_view():
    cur.execute("""CREATE VIEW search AS
                (SELECT pijaca.id, pijaca.ime, pijaca.drzava, pijaca.velikost, pijaca.stopnja_alkohola, pijaca.slika, pijaca.cena, vrsta.id AS vrsta, hrana.ime AS hrana FROM pijaca
